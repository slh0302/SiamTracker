...
This repository includes PyTorch mcode for reproducing the results on VOT2018.
...
Then, you should copy the pretrained model file `SiamRPNBIG.model` to the subfolder './mcode', so that the tracker can find and load the pretrained_model.
...
If you find **SiamTracker** and **SiamRPN** useful in your research, please consider citing:
